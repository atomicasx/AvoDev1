...
$hook_array['after_ui_frame'][] = Array(2, 'Load Social JS', 'include/social/hooks.php','hooks', 'load_js'); 
$hook_array['after_ui_frame'][] = Array(1, 'Maintenance', 'custom/modules/Users/MaintenanceHook.php', 'MaintenanceHook', 'CheckMaintenance');
