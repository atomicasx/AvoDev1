...
$hook_array['after_save'][] = Array(81,'ADDCustomer','custom/modules/Accounts/addcustomer.php','class_addcustomer','func_addcustomer');
$hook_array['after_save'][] = Array(81,'phonenumber','custom/modules/Accounts/phnum.php','class_phnum','func_phnum');
$hook_array['before_save'][] = Array(1, 'Validate Addres with Google API', 'custom/modules/Accounts/validateaddress.php','Geocode', 'validateAddress');
