...
$pdf->Cell($width_cell[0],10,1,1,0,C,$fill);
$pdf->Cell($width_cell[1],10,"Sagar",1,0,L,$fill);
$pdf->Cell($width_cell[2],10,"First",1,0,C,$fill);
$pdf->Cell($width_cell[3],10,"100%",1,0,C,$fill);
$pdf->Cell($width_cell[4],10,"Male",1,1,C,$fill);

/// end of records /// 
header("Content-length: $size"); 
        header("Content-type: $type"); 
        header("Content-Disposition: inline; filename=invoiceReport.pdf");
$pdf->Output();
