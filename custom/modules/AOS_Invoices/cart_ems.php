    ...
    if($que->num_rows <= 0)
     {   
      ...
      while($row11 = $query11->fetch_assoc()){
        ...
        $query = $cart_conn->query("INSERT INTO oc_order_product SET order_product_id = '".$order_product_id."',order_id = '".$order_id."',price = '".$price."',tax = '".$tax."',name = '".$product_name."',quantity = '".$quantity_products."',model = '".$product_name."',product_id = '".$product_id."',total = '".$total_price."',reward = '0'");
        $GLOBALS['log']->fatal("INSERT INTO oc_order_product SET order_product_id = '".$order_product_id."',order_id = '".$order_id."',price = '".$price."',tax = '".$tax."',name = '".$product_name."',quantity = '".$quantity_products."',model = '".$product_name."',product_id = '".$product_id."',total = '".$total_price."',reward = '0'"); 
        $order_product_id++;
