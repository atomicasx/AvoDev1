    ...
    array (
      ...
      array (
        ...
        array (
		  ...
		  'ResetBtn' => 
          array (
            'customCode' => '<input type="button" class="button" onClick="ResetDeliveryStatus(\'{$fields.id.value}\');" value="Reset Buttons">',
          ),
      ...
      array (
        0 => 
        array (
          'file' => 'custom/modules/AOS_Invoices/js/DetailView.js',
        ),
    ...
    array (
      ...
      array (
        ...
        array (
		  ...
		  array (
			'name' => 'overdue_status',
            // 'customCode' => '<b style="color:#f08377;">{$OverdueStatus}</b>',
            'customCode' => '<b style="color:{$Color};">{$OverdueStatus}</b>',
            'customLabel' => 'Overdue Status',
          ),
        ),
        4 => 
        array (
