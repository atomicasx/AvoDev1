...
define('SITE_KEY',"6LdOnM4UAAAAAF_LTwOaMhzxUe_950EdPlUEbl6E"); 
define('SECRET_KEY',"6LdOnM4UAAAAADn49PRCobWTXqpN25cul_1KcSrE");
?>
...
<div class="p_login">
    ...
    <div id="loginform">
		...
		{sugar_translate label="WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING"}
            ...
            <br>
            <div class="g-recaptcha" data-sitekey="6LdOnM4UAAAAAF_LTwOaMhzxUe_950EdPlUEbl6E"></div>  
            <br>
