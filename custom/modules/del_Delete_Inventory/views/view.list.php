...
//require_once('modules/qr_QR_Boxes/qr_QR_BoxesListViewSmarty.php');
    class del_Delete_InventoryViewList extends ViewList{
        //public $type ='list';
...
<script>
    $(document).ready(function(){
		...
		$(".deleterec").click(function(){
			...
			var confirmed1 = confirm("Alert 1 : Are you sure to detele all the data for this module ?");
			
			if(confirmed1) {
				
				var confirmed1 = confirm("Alert 2 : Are you sure to detele all the data for this module ?");
				var modulename = $(this).attr('modulename');
				if(confirmed1) {
					window.location = "index.php?entryPoint=archivedata&modulename="+modulename;
				}
