...
function insertProductLine(tableid, groupid) {
  ...
  var productcategorylist_hidden = document.getElementById("productcategorylisthidden").value;
  ...
  sqs_objects["product_name[" + prodln + "]"] = {
    ...
    "group": "or",
    "field_list": ["name", "id", "part_number", "cost", "price", "description", "currency_id", "rayados_breaking_price_c", "maduros_ripe_price_c", "verdes_firm_price_c"],
    "populate_list": ["product_name[" + prodln + "]", "product_product_id[" + prodln + "]", "product_part_number[" + prodln + "]", "product_product_cost_price[" + prodln + "]", "product_product_list_price[" + prodln + "]", "product_item_description[" + prodln + "]", "product_currency[" + prodln + "]", "product_category_list_c[" + prodln + "]", "rayados_breaking_price_c[" + prodln + "]", "maduros_ripe_price_c[" + prodln + "]", "verdes_firm_price_c[" + prodln + "]"],
  ...
  sqs_objects["product_part_number[" + prodln + "]"] = {
    ...
    "modules": ["AOS_Products"],
    "group": "or",
    "field_list": ["part_number", "name", "id","cost", "price","description","currency_id", "rayados_breaking_price_c", "maduros_ripe_price_c", "verdes_firm_price_c"],
    "populate_list": ["product_part_number[" + prodln + "]", "product_name[" + prodln + "]", "product_product_id[" + prodln + "]",  "product_product_cost_price[" + prodln + "]", "product_product_list_price[" + prodln + "]", "product_item_description[" + prodln + "]", "product_currency[" + prodln + "]", "product_category_list_c[" + prodln + "]", "rayados_breaking_price_c[" + prodln + "]", "maduros_ripe_price_c[" + prodln + "]", "verdes_firm_price_c[" + prodln + "]"],
    "required_list": ["product_id[" + prodln + "]"],
    "conditions": [{
      "name": "part_number",
      "op": "like_custom",
...
var b4 = x.insertCell(4);
    b4.innerHTML = "<select onchange='selectProductCategory(" + prodln + ");' class='sqsEnabled product_category_list_c yui-ac-input' autocomplete='off' name='product_product_category_list_c[" + prodln + "]' id='product_product_category_list_c" + prodln + "' >" +productcategorylist_hidden+" </select><input type='hidden' name='product_verdes_firm_price_c[" + prodln + "]' id='product_verdes_firm_price_c" + prodln + "' value=''  /><input type='hidden' name='product_maduros_ripe_price_c[" + prodln + "]' id='product_maduros_ripe_price_c" + prodln + "' value=''  /><input type='hidden' name='product_rayados_breaking_price_c[" + prodln + "]' id='product_rayados_breaking_price_c" + prodln + "' value=''  />";
...
function selectProductCategory(ln)
{
    //alert($("#product_category_list_c"+ln).val());
    $("#product_product_list_price"+ln).val($("#product_"+$("#product_product_category_list_c"+ln).val().toLowerCase()+"_price_c"+ln).val());
...
function openProductPopup(ln){
  ...
  var popupRequestData = {
    ...
    "field_to_name_array" : {
      ...
      "verdes_firm_price_c" : "product_product_list_price" + ln,
      "currency_id" : "product_currency" + ln,
      "rayados_breaking_price_c" : "product_rayados_breaking_price_c" + ln,
      "maduros_ripe_price_c" : "product_maduros_ripe_price_c" + ln
    }
  };
...
function setProductReturn(popupReplyData){
  ...
  $("#product_verdes_firm_price_c"+lineno).val($("#product_product_list_price"+lineno).val());
  $("#product_product_category_list_c"+lineno).val("Verdes_Firm");
...
function insertServiceLine(tableid, groupid) {
  ...
  var vat_hidden = document.getElementById("vathidden").value;
  var productcategorylisthidden = document.getElementById("productcategorylisthidden").value;
...
function insertGroup()
{
  ...
  if(enable_groups){
   ...
   // footer_cell3.innerHTML="<span class='totals'><label>"+SUGAR.language.get(module_sugar_grp1, 'LBL_SUBTOTAL_AMOUNT')+":</label><input name='group_subtotal_amount[]' id='"+ table.id +"subtotal_amount' class='group_subtotal_amount'  maxlength='26' value='' title='' Stabindex='120' type='text' readonly></span>";
