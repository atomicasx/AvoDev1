...
if (isset($_COOKIE['inactiveloginErrorMessage'])) {
	$sugar_smarty->assign('LOGIN_ERROR_MESSAGE', $_COOKIE['inactiveloginErrorMessage']);
	SugarApplication::setCookie('inactiveloginErrorMessage', '', time() - 42000);
	setcookie("inactiveloginErrorMessage", '', time() - 3600);
}
if (isset($_REQUEST['loginErrorMessage'])) {
