...
if (isset($_POST['g-recaptcha-response'])) {
    ...
    $recaptcha = new \ReCaptcha\ReCaptcha('6LdOnM4UAAAAADn49PRCobWTXqpN25cul_1KcSrE', new \ReCaptcha\RequestMethod\SocketPost());
    ...
    //print_r($resp);exit;
      if (!$resp->isSuccess()) {
            ...
            $GLOBALS['log']->fatal(
                ...
                'ip[' . query_client_ip() . '], username[' . $user_name . ']'
            );
        ob_clean();
		setcookie("inactiveloginErrorMessage", '<b>Captcha</b> Validation Required!', time() + 3600);
