...
class qr_QR_BoxesViewDetail extends ViewDetail 
{
	...
	function populateBoxesTemplates()
	{
		global $db,$app_list_strings; 
		$sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted = 0 AND type='qr_QR_Boxes' AND active = 1"; 
